...
.bgimg {background-image: url("online-education.jpg")}
.bgimg2 {background-image: url("online-education.jpg")}
.dropdown {
  float: left;
  overflow: hidden;
}
...
<div class="w3-bottom w3-hide-small">
  <div class="w3-bar w3-white w3-center w3-padding w3-opacity-min w3-hover-opacity-off">
    <a href="cart.html" style="width:25%" class="w3-bar-item w3-button">cart</a>
    <a href="marketplace.html" style="width:25%" class="w3-bar-item w3-button">Market Place</a>
    <a href="messages.php" style="width:25%" class="w3-bar-item w3-button">Message History</a>
    <a href="contactUs.html" style="width:25%" class="w3-bar-item w3-button w3-hover-black">contact us</a>
      <a href="MyProfile.php"style="width:25%" class="w3-bar-item w3-button w3-hover-black">Change Profile Picture</a>
      <a href="editemail.php"style="width:25%" class="w3-bar-item w3-button w3-hover-black">Change Email</a>
      <a href="editpass.php"style="width:25%" class="w3-bar-item w3-button w3-hover-black">Change Password</a>
      <a href="DeleteAcount.php"style="width:25%" class="w3-bar-item w3-button w3-hover-black">Delete Account</a>
      <a href="logout.php"style="width:25%" class="w3-bar-item w3-button w3-hover-black">Logout</a>
  </div>
...
<div class="w3-container w3-padding-64 w3-pale-red w3-grayscale-min w3-center" id="wedding">
  <div class="w3-content">
    <h1 class="w3-text-grey"><b>Exploring the different eLearning methods</b></h1>
    <img class="w3-round-large w3-grayscale-min" src="101-Best-Online-Business-Courses-to-Learn-and-Grow-This-Year-Hero-Image.jpg" style="width:100%;margin:64px 0">
    <div class="w3-row">
      <div class="w3-half">
...
<div class="w3-container w3-padding-64 w3-pale-red w3-center w3-wide" id="rsvp">
  ...
  <p class="w3-large">More Online  Courses Are Coming Soon!</p>
