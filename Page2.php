...
<div class="w3-bottom w3-hide-small">
  <div class="w3-bar w3-white w3-center w3-padding w3-opacity-min w3-hover-opacity-off">
    <a href="index.php" style="width:25%" class="w3-bar-item w3-button">cart</a>
    <a href="marketplace.php" style="width:25%" class="w3-bar-item w3-button">Market Place</a>
    <a href="adminchat.php" style="width:25%" class="w3-bar-item w3-button">Message History</a>
    <a href="contactUs.html" style="width:25%" class="w3-bar-item w3-button w3-hover-black">contact us</a>
      ...
      <a href="logout.php"style="width:25%" class="w3-bar-item w3-button w3-hover-black">Logout</a>
       <?php //echo "<img src='".$_SESSION['img'] ."' width=50 >" ?>
  </div>
