                ...
                <div class="add_admin_content">
                    ...
                    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data" method="post">
                        ...
                        <p>
                            ...
                            <br>
                            <textarea name="course_desc" name="course_desc" style="height: 20%; width: 30%;" cols="30" rows="10" ></textarea>
                        </p>
                        <p>
...
$acc=1;
    ...
    $insert_post = "insert into courses (CourseId,CourseName,CourseDesc,CourseImage,CourseContent,VideoLink, CoursePrice,Accepted) values ('$post_categories','$post_title','$course_desc','$post_featured_image','$course_content','$course_video', '$post_price','$acc')";
